...
public class ReportPackageImpl extends EPackageImpl implements ReportPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getShadowing_Shadowing(), ecorePackage.getEObject(), null, "shadowing", null, 1, 1, Shadowing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getShadowing_Shadowed(), ecorePackage.getEObject(), null, "shadowed", null, 1, 1, Shadowing.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCompleteness_SecurityConstraint(), ecorePackage.getEObject(), null, "securityConstraint", null, 1, 1, Completeness.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(redundancyEClass, Redundancy.class, "Redundancy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRedundancy_Containing(), ecorePackage.getEObject(), null, "containing", null, 1, 1, Redundancy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRedundancy_Contained(), ecorePackage.getEObject(), null, "contained", null, 1, 1, Redundancy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
