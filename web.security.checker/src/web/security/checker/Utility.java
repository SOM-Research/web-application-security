...
public class Utility {
	...
	public static final String ANOMALIES_METAMODEL_PATH = getLocation() + metamodelsFolder + "report.ecore";
	...
	public static final String CHECKING_UNDECLARED_ROLES = "/" + transformationsFolder + "checkingSyntactical.asm";
