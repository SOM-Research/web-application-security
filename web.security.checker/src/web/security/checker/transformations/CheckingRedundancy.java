...
public class CheckingRedundancy {
	
	private ILauncher launcher;
	private IProgressMonitor ip;
	
	private String servletSecurityPath;
	private String redundancyPath;
	
	public CheckingRedundancy(String servletSecurityPath, String redundancyPath) {
		this.servletSecurityPath = servletSecurityPath;
		this.redundancyPath = redundancyPath;
	}
	...
	public void run() throws IOException, ATLCoreException {
		...
		paths.put("OUT", URI.createFileURI(this.redundancyPath).toString());
		...
		URL transformation  = this.getClass().getResource(Utility.CHECKING_REDUNDANCY);
