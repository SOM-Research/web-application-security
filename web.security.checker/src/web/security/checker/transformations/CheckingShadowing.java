...
public class CheckingShadowing {
	
	private ILauncher launcher;
	private IProgressMonitor ip;
	
	private String servletSecurityPath;
	private String shadowingPath;
	
	public CheckingShadowing(String servletSecurityPath, String shadowingPath) {
	...
	public void run() throws IOException, ATLCoreException {
		...
		paths.put("OUT", URI.createFileURI(this.shadowingPath).toString());
		...
		URL transformation  = this.getClass().getResource(Utility.CHECKING_SHADOWING);
