...
public class CheckingReachability {
	
	private ILauncher launcher;
	private IProgressMonitor ip;
	
	private String servletSecurityPath;
	private String reachabilityPath;
	
	public CheckingReachability(String servletSecurityPath, String reachabilityPath) {
		this.servletSecurityPath = servletSecurityPath;
		this.reachabilityPath = reachabilityPath;
	}
	...
	public void run() throws IOException, ATLCoreException {
		...
		paths.put("OUT", URI.createFileURI(this.reachabilityPath).toString());
		...
		URL transformation  = this.getClass().getResource(Utility.CHECKING_REACHABILITY);
