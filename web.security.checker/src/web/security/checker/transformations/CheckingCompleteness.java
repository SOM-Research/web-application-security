...
public class CheckingCompleteness {
	...
	public CheckingCompleteness(String servletSecurityPath, String completenessPath) {
		this.servletSecurityPath = servletSecurityPath;
		this.completenessPath = completenessPath;
	}
	...
	public void run() throws IOException, ATLCoreException {
		...
		paths.put("OUT", URI.createFileURI(this.completenessPath).toString());
		...
		URL transformation  = this.getClass().getResource(Utility.CHECKING_COMPLETENESS);
