...
public class EjbSecurity2PIM {
	...
	public EjbSecurity2PIM(String ejbPSMSecurityPath, String ejbPIMSecurityPath) {
		this.psmPath = ejbPSMSecurityPath;
		this.pimPath = ejbPIMSecurityPath;
	}
	...
	public void run() throws IOException, ATLCoreException {
		...
		paths.put("EJB", Utility.EJB_SECURITY_METAMODEL_PATH);
		paths.put("PIM", Utility.WEB_SECURITY_METAMODEL_PATH);
		
		Map<String, Object> options = new HashMap<String, Object>();

		URL transformation  = this.getClass().getResource(Utility.EJB_SECURITY_2_PIM);
